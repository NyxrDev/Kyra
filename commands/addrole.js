...
exports.run = (client, message, args) => {
    ...
    let role = message.guild.roles.cache.find('name', name);
    ...
    message.channel.send(`:ballot_box_with_check: **${message.author.username}**, I've added the **${name}** role to **${message.mentions.users.first().username}**.`);
}
