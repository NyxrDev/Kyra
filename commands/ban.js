...
exports.run = (client, message, args) => {
  ...
  if (user.id === message.guild.owner.id) return message.channel.send("Nice one, but that wont happen. >:(")
  if (message.mentions.users.first().id === "523579776749928449") return message.channel.send("You can't ban my Developer:wink:");
